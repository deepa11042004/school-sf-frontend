...
const dummyExpenseHeads: ExpenseHead[] = [
  {
    id: "1",
    name: "XYZ",
    description: "",
  },
  {
    ...
    description: "Stationery and general office needs",
  },
  {
    id: "3",
    name: "Maintenance",
...
export default function ExpensesHeads() {
  ...
  const currentHeads = filteredHeads.slice(startIndex, endIndex);
