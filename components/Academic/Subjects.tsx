...
import { Sheet, Download, Upload, Plus } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const dummySubjects: SubjectProp[] = [
  {
    id: "1",
    sortOrder: 1,
    name: "English",
...
export default function Subjects() {
  ...
  const totalPages = Math.ceil(
    filteredSubjects.length / parseInt(entriesPerPage),
  );
        ...
        <Dialog open={openImportDialog} onOpenChange={setOpenImportDialog}>
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>
                Upload a CSV file to bulk import subjects. "Name" and "Code" are
                required. To assign teachers, provide comma-separated Teacher
                IDs in the "Teacher IDs" column.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="rounded-lg border bg-muted/30 p-3">
                ...
                <Button variant="link" className="h-auto">
                  <a href="/download/subjects_import_sample.csv" download>
                    Download Sample CSV
                  </a>
                </Button>
              </div>
            ...
            <DialogFooter>
              ...
              <Button disabled={!file}>Import Subjects</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
