...
export default function ClassRoom() {
  ...
  const filteredClassrooms = dummyClassrooms.filter(
    (classroom) =>
  ...
  const totalPages = Math.ceil(
    filteredClassrooms.length / parseInt(entriesPerPage),
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/academic/class-room/create">
        ...
        <Dialog open={openImportDialog} onOpenChange={setOpenImportDialog}>
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              <DialogTitle>Import Classrooms</DialogTitle>
              <DialogDescription>
                Upload a CSV file to bulk import classrooms. The "Name" field is
                required. Status should be "ok" or "maintenance". Capacity
                should be a number.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="rounded-lg border bg-muted/30 p-3">
                ...
                <Button variant="link" className="h-auto">
                  <a href="/download/classrooms_import_sample.csv" download>
                    Download Sample CSV
                  </a>
                </Button>
              </div>
              ...
              <div className="p-4 sm:p-6 border-t border-slate-100">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="text-sm text-slate-600">
                    Showing{" "}
                    {filteredClassrooms.length === 0 ? 0 : startIndex + 1} to{" "}
                    {Math.min(endIndex, filteredClassrooms.length)} of{" "}
                    {filteredClassrooms.length} entries
                  </div>
