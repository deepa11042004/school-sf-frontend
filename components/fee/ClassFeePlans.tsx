...
const dummyPlans: ClassFeePlan[] = [
  {
    id: "1",
    academicYear: "2026-27",
    className: "NC - A",
    planName: "NC A 2026-27",
    status: "Active",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    academicYear: "2026-27",
    className: "IX - A",
    planName: "IX A 2026-27",
    status: "Active",
  },
];

export default function ClassFeePlans() {
  ...
  const filteredPlans = dummyPlans.filter(
    (plan) =>
      plan.className.toLowerCase().includes(searchTerm.toLowerCase()) ||
      plan.planName.toLowerCase().includes(searchTerm.toLowerCase()),
  );

  const totalPages = Math.ceil(filteredPlans.length / parseInt(entriesPerPage));
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/fee/class-fee-plans/create">
