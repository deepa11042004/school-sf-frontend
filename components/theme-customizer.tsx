...
export function ThemeCustomizer() {
  ...
  const applyThemeColors = useCallback(
    (config: ThemeConfig, isDark: boolean) => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      (window as any).setMenuStateFromCustomizer
    ) {
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Select
                    ...
                    onValueChange={(value: "full" | "collapsed" | "hidden") =>
                      updateConfig("menuState", value)
                    }
                  >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={editingDarkMode}
                    onCheckedChange={setEditingDarkMode}
                  />
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Label className="font-medium">
                      Colors ({editingDarkMode ? "Dark" : "Light"})
                    </Label>
                  </div>
                  ...
                  <div className="grid gap-3 max-h-80 overflow-y-auto">
                    ...
                    <ColorInput
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.foreground
                          : config.colors.light.foreground
                      }
                    />
                    <ColorInput
                      label="Primary"
                    ...
                    <ColorInput
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.card
                          : config.colors.light.card
                      }
                    />
                    ...
                    <ColorInput
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.menuText
                          : config.colors.light.menuText
                      }
                    />
                    <ColorInput
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.menuTextHover
                          : config.colors.light.menuTextHover
                      }
                    />
                    <ColorInput
                      label="Menu Icon"
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.menuIcon
                          : config.colors.light.menuIcon
                      }
                    />
                    <ColorInput
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.menuIconHover
                          : config.colors.light.menuIconHover
                      }
                    />
                    <ColorInput
                      ...
                      value={
                        editingDarkMode
                          ? config.colors.dark.menuSectionLabel
                          : config.colors.light.menuSectionLabel
                      }
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <Label className="text-xs font-medium">
                        Border Radius: {config.card.borderRadius}px
                      </Label>
                      <Slider
                        value={[config.card.borderRadius]}
                        onValueChange={([value]) =>
                          updateConfig("card.borderRadius", value)
                        }
                        max={20}
                        min={0}
                        step={1}
                    ...
                    <div>
                      <Label className="text-xs font-medium">
                        Border Width: {config.card.borderWidth}px
                      </Label>
                      <Slider
                        value={[config.card.borderWidth]}
                        onValueChange={([value]) =>
                          updateConfig("card.borderWidth", value)
                        }
                        max={5}
                        min={0}
                        step={1}
                    ...
                    <div>
                      <Label className="text-xs font-medium">
                        Padding: {config.card.padding}px
                      </Label>
                      <Slider
                        value={[config.card.padding]}
                        onValueChange={([value]) =>
                          updateConfig("card.padding", value)
                        }
                        max={48}
                        min={8}
                        step={4}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) =>
                          updateConfig("button.borderRadius", value)
                        }
                        max={20}
                        min={0}
                        step={1}
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) =>
                          updateConfig("button.fontSize", value)
                        }
                        max={20}
                        min={10}
                        step={1}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) =>
                          updateConfig("typography.fontSize", value)
                        }
                        max={20}
                        min={10}
                        step={1}
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          updateConfig("typography.fontWeight", value)
                        }
                      >
                        <SelectTrigger className="h-8">
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Slider
                        ...
                        onValueChange={([value]) =>
                          updateConfig("typography.lineHeight", value)
                        }
                        max={2}
                        min={1}
                        step={0.1}
