...
const dummyYears: AcademicYearProps[] = [
  {
    id: "1",
    name: "2026-27",
...
export default function AcademicYear() {
  ...
  const filteredYears = dummyYears.filter(
    (year) =>
  ...
  const totalPages = Math.ceil(filteredYears.length / parseInt(entriesPerPage));
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <Link href="/settings/academic-year/create">
                  ...
                  {filteredYears.length === 0 ? (
                    ...
                    currentYears.map((year) => (
                      ...
                      >
                        ...
                        <TableCell className="py-3 ">{year.endDate}</TableCell>
                        <TableCell className="py-3">
                          {year.status && (
