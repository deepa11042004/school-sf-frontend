...
export default function Books() {
  ...
  // Dummy data - keeping it empty to show the "No books found." state as requested
  ...
  const filteredBooks = dummyBooks.filter((book) => {
    ...
    return matchesSubject && matchesType && matchesKeyword;
  });

  const totalPages = Math.ceil(
    filteredBooks.length / parseInt(entriesPerPage)
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <Link href="/management/library/books/create">
                  ...
                  {currentBooks.length === 0 ? (
                    ...
                    currentBooks.map((book) => (
                      ...
                      >
                        ...
                        <TableCell className="py-3">{book.type}</TableCell>
                        <TableCell className="py-3">
                          <span
