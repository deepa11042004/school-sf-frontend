...
export default function TrasnportRoutes() {
  ...
  const filteredRoutes = dummyRoutes.filter(
    (route) =>
  ...
  const totalPages = Math.ceil(
    filteredRoutes.length / parseInt(entriesPerPage),
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <Link href="/management/transport/route/create">
                  ...
                  {currentRoutes.length === 0 ? (
                    ...
                    currentRoutes.map((route) => (
                      <TableRow key={route.id}>
                        ...
                        <TableCell className="py-3">{route.driver}</TableCell>
                        <TableCell className="py-3">{route.vehicle}</TableCell>
                        <TableCell className="py-3">{route.stops}</TableCell>
