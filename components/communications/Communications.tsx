...
const dummyLogs: CommunicationLog[] = [];
...
export default function CommunicationLogs() {
  ...
  const filteredLogs = dummyLogs.filter(
    (log) =>
      ...
      log.recipientGroup.toLowerCase().includes(searchTerm.toLowerCase()) ||
                  ...
                  {filteredLogs.length === 0 ? (
                    ...
                    currentLogs.map((log) => (
                      ...
                      >
                        ...
                        <TableCell className="py-3 text-center font-medium text-slate-900 whitespace-nowrap">
                          {log.count}
                        </TableCell>
                        <TableCell className="py-3 text-slate-700 whitespace-nowrap">
                          {log.subject}
                        </TableCell>
                        <TableCell className="py-3 text-slate-500 max-w-xs truncate whitespace-nowrap">
                          {log.messagePreview}
                        </TableCell>
                        <TableCell className="py-3 text-slate-700 whitespace-nowrap">
                          {log.sender}
