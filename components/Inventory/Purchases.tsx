...
export default function Purchases() {
  ...
  // Dummy data - keeping it empty to show the "No purchases found." state as requested
  ...
  const totalPages = Math.ceil(
    filteredPurchases.length / parseInt(entriesPerPage)
  );
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <Link href="/inventory/purchases/create">
                  ...
                  {currentPurchases.length === 0 ? (
                    ...
                    currentPurchases.map((purchase) => (
                      ...
                      >
                        ...
                        <TableCell className="py-3">{purchase.vendor}</TableCell>
